...
// gltf samplers use # and props from opengl so we must convert
...
std::optional<std::shared_ptr<LoadedGLTF>> loadGltf(VulkanEngine* engine, std::string_view filePath) {
    ...
    // load the file depending on whether it's a gltf or a glb
    ...
    std::vector<DescriptorAllocator2::PoolSizeRatio> sizes = { { VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 3 },
    ...
    // create buffer to hold the material data for descriptor set
